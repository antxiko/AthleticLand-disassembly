...
**The game is not ours.** *Athletic Land* was published by **Konami** in 1984
as the RC-700 cartridge for the MSX. All rights over the game remain with their
holders.
...
The file `src/athletic.asm` is the commented disassembly of the cartridge. It
...
If you worked on *Athletic Land* or hold rights over the game, and you would
